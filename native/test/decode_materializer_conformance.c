...
int main(void) {
  static const uint8_t source[] = "null";
  ...
  CHECK(view.nodes == NULL && view.node_count == 0 && view.edges == NULL &&
        view.edge_count == 0 && view.copied_bytes == NULL &&
        view.copied_byte_count == 0 && view.root_node == UINT64_MAX &&
        view.reserved == 0);
