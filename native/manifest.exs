...
[
  ...
  qualification_inputs: [
    ...
    ".spec/decisions/0014-production-native-pool-routing-and-telemetry.md",
    ...
    ".spec/planning/milestone_04_worker_pool/phase-05-telemetry-public-operations-and-lifecycle.md",
    ".spec/planning/milestone_04_worker_pool/phase-06-saturation-qualification-and-activation.md",
    ...
    ".spec/planning/milestone_06_publication_readiness/README.md",
    ".spec/planning/milestone_06_publication_readiness/phase-01-release-contract-licensing-and-package-identity.md",
    ".spec/planning/milestone_06_publication_readiness/phase-02-cold-cache-ci-reliability-and-merge-gates.md",
    ".spec/planning/milestone_06_publication_readiness/phase-03-package-metadata-installation-and-public-documentation.md",
    ".spec/planning/milestone_06_publication_readiness/phase-04-release-tooling-provenance-and-recovery.md",
    ".spec/planning/milestone_06_publication_readiness/phase-05-release-candidate-qualification-and-go-no-go.md",
    ".spec/planning/milestone_06_publication_readiness/phase-06-version-tag-publish-and-post-publish-verification.md",
    ...
    "scripts/ci/qualify_native_pool.sh",
    "scripts/ci/qualify_decode.sh",
    "scripts/ci/qualify_decode_benchmark.sh",
    "scripts/ci/qualify_milestone_5.sh",
    "scripts/ci/bootstrap_release_tools.sh",
    ...
    "test/native/pool_public_operations_test.exs",
    "test/native/pool_public_stream_test.exs",
    ...
    "test/release/ci_reliability_contract_test.exs",
    "test/release/package_documentation_contract_test.exs",
    "test/release/release_tooling_contract_test.exs",
